  ...
  horses: router({
    create: protectedProcedure
      .input(z.object({
        ...
        feedingScheduleData: z.object({
          type: z.enum(["2x_daily", "3x_daily", "4x_daily", "custom"]),
          slots: z.array(z.object({
            id: z.string(),
            name: z.string(),
            time: z.string(),
            icon: z.string(),
            hay: z.object({ amount: z.number(), unit: z.string() }),
            grain: z.object({ amount: z.number(), unit: z.string(), type: z.string() }),
            supplements: z.array(z.string()),
            water: z.boolean(),
            notes: z.string(),
          })),
          weeklyVariations: z.boolean(),
